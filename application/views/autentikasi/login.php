...
<head>
  ...
  <title>LOGIN | Kantor Konsultan Pajak dan Hukum</title>
  ...
  <div id="app">
    <section class="section">
      <div class="d-flex flex-wrap align-items-stretch">
          ...
          <div class="p-4 m-3">
            ...
            <form method="POST" action="<?php echo base_url('Autentikasi/Masuk') ?>" class="needs-validation" novalidate="">
              ...
              <div class="mt-5 text-center">
                <a href="http://www.konsultanpajakindo.com">Home</a> | Belum Punya Akun? <a href="<?= site_url('Autentikasi/Register') ?>">Register</a>
              </div>
            </form>
        ...
        <div class="col-lg-8 col-12 order-lg-2 order-1  background-walk-y position-relative overlay-gradient-bottom"
        data-background="<?php echo base_url(); ?>assets/img/unsplash/login-bg-cms-kkp.png">
